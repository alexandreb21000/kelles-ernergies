    ...
    <div class="w-1200 m-auto d-flex flex-rowreverse jc-center bgcolor1 d-block-sm">
        ...
        <div class="w-80 d-flex d-block-sm">
            <div class="p-contenu w-80-sm m-auto">
                ...
                <div class="d-flex jc-center flex-col marg-bull">
                    <iframe scrolling="auto" id="haWidget" allowtransparency="true" src="https://www.helloasso.com/associations/k-elles-energies-bourgogne/adhesions/bulletin-d-adhesion/widget" style="width:100%;height:750px;border:none;" onload="window.scroll(0, this.offsetTop)"></iframe>
                    </div>
                </div>
            </div>                  
        </div>
    ...
    <div class="w-1200 m-auto d-flex jc-center d-block-sm">
        ...
        <div class="w-80 d-flex d-block-sm">
            <div class="p-contenu m-auto w-80-sm">
                ...
                <div class="txt-end">
                <iframe class="txt-end" id="haWidget" allowtransparency="true" src="https://www.helloasso.com/associations/k-elles-energies-bourgogne/adhesions/bulletin-d-adhesion/widget-bouton" style="width:100%;height:70px;border:none;"></iframe>
                </div>
                <p class="txt-center playfair fs24">Lorem Ipsum</p>
                <hr width="40%">
                <p class="txt-justify noto fs15">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in diam nec purus egestas pretium vel sit amet lectus.
                ...
                <iframe id="haWidget" allowtransparency="true" src="https://www.helloasso.com/associations/k-elles-energies-bourgogne/adhesions/bulletin-d-adhesion/widget-bouton" style="width:100%;height:70px;border:none;"></iframe>
            </div>      
        </div>
    </div>
