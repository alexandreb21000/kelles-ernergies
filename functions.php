<?php
/**
 * Kelles Energies functions and definitions
 *
...
if ( ! function_exists( 'kelles_energies_setup' ) ) :
	 ...
	 */
	function kelles_energies_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Kelles Energies, use a find and replace
		 * to change 'kelles-energies' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'kelles-energies', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'kelles-energies' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'kelles_energies_custom_background_args', array(
...
add_action( 'after_setup_theme', 'kelles_energies_setup' );
 ...
 */
function kelles_energies_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'kelles_energies_content_width', 640 );
}
add_action( 'after_setup_theme', 'kelles_energies_content_width', 0 );
 ...
 */
function kelles_energies_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'kelles-energies' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'kelles-energies' ),
...
add_action( 'widgets_init', 'kelles_energies_widgets_init' );
...
function kelles_energies_scripts() {
	...
	get_template_directory_uri() . '/js/burger-menu-script.js',
	array() );	
...
add_action( 'wp_enqueue_scripts', 'kelles_energies_scripts' );
